...
export default function ControlPanel({
  ...
  return (
    <div className={`flex flex-col gap-4.5 rounded-3xl border p-5 transition-all duration-300 ${cardBgClass}`}>
      ...
      <div className="flex flex-col gap-2 p-3 rounded-2xl bg-amber-500/5 dark:bg-amber-500/5 border border-amber-500/20 dark:border-amber-500/20 shadow-sm">
        <label className="text-[10px] uppercase font-black tracking-wider text-amber-600 dark:text-amber-400 flex items-center gap-1.5">
          ...
          Mejor Ubicación del Router
        </label>
        
        <p className="text-[9px] text-slate-400 dark:text-slate-500 leading-normal">
          Analiza el mapa actual (con todas las paredes y obstáculos) resolviendo ecuaciones Laplace en segundos para encontrar las coordenadas óptimas de mayor cobertura.
        </p>
        ...
        {isOptimizing ? (
          ...
          >
            ...
            Analizando coberturas...
          </button>
        ) : (
          <button
            onClick={onFindBestRouterPlace}
            className="w-full flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl font-bold bg-amber-500 hover:bg-amber-600 text-white transition hover:scale-[1.01] cursor-pointer text-xs shadow-md shadow-amber-500/10 animate-fade-in"
          >
        ...
        {optimizationResult && (
          <div className="mt-1 p-2.5 rounded-xl border border-amber-500/20 bg-amber-500/10 dark:bg-amber-950/30 flex flex-col gap-2.5 text-[10px] animate-fade-in">
            ...
            {/* Comparación de los distintos puntos testeados */}
      ...
      <div className="flex flex-col gap-1.5 p-3 rounded-2xl bg-indigo-50/20 dark:bg-slate-950/25 border border-indigo-100/30 dark:border-slate-850">
        ...
        <div className="p-2 border rounded-xl bg-white/50 dark:bg-slate-900/40 text-[10px] flex flex-col gap-1 text-slate-500 font-medium border-slate-100 dark:border-slate-800">
          ...
          <p className="text-[9px] text-slate-400 dark:text-slate-500 leading-normal mt-1 italic">
